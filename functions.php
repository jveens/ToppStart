 ...
 */
  ...
  */
 define( 'TOPP_START_VERSION', '1.0.0' );
...
wp_enqueue_script(
 ...
 add_action( 'after_setup_theme', function() {
   $theme_settings = [
      ...
      */
     'menu_locations' => [
       'primary' => __( 'Primary Menu', 'toppstart' ),
     ],
      ...
      * https://github.com/digitoimistodude/toppstart#custom-taxonomies
      */
     'taxonomies' => [
      ...
      *
      * See the instructions:
      * https://github.com/digitoimistodude/toppstart#custom-post-types
      */
     'post_types' => [
       // 'Your_Post_Type',
     ],
   ...
   $theme_settings = apply_filters( 'topp_start_theme_settings', $theme_settings );
